...
namespace TemperatureFunc
{
    public class ThermometerController
    {
        ...
        /// </summary>
        private static GameObject _leftObj;
        ...
        /// 温度計の隠しオブジェクト左。動かない。
        /// </summary>
        private static GameObject _rightObj;
        ...
        //private static GameObject LeftObj;

        /// <summary>
        /// Allinitの場合、温度の計算で使用するオブジェクトを取得し位置を初期化する。そうでない場合もオブジェクトの位置を初期化する。
        /// </summary>
        /// <param name="isAllInit">オブジェクトの取得を行うかどうか</param>
        public void ThermoConObjInit(bool isAllInit)
        {
            if (isAllInit)
            {
            ...
            _leftObj.transform.position = new Vector3(0.0f, 0.0f, 0.0f);
